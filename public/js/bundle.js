...
var _hideAlert = exports.hideAlert = function hideAlert() {
  _hideAlert();
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
  window.setTimeout(_hideAlert, 5000);
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("succcess", "".concat(type.toUpperCase(), " updated successfully"));
          }
          _context.next = 11;
          break;
        case 8:
...
var stripe = Stripe(pk_test_51PpxeXCsmvZLQysRX5aeYGKaORVlE2nVgGWxKrmTXgtXZoeFAPvuHOnpCxgujGlXRDnxvUBQqoHUXEIBaX59hm4v00PuMzcrxW);
